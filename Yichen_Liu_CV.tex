...
\begin{itemize}[leftmargin=1.5em]
    \item Completed Junior Year of \textbf{Applied Physics and Chemistry} (\textbf{Honour})  %\hfill \textbf{3.40/4.00} (last year: 3.81)
...
\begin{itemize}[leftmargin=1.5em]
    ...
    \end{itemize}
    \item \textbf{Project 4: black hole - host galaxy relation of AGNs in DES deep fields (leading)} \hfill $\rceil$ % 2023/06 - Present
    \begin{itemize}[leftmargin=1.5em]
    ...
    \end{itemize}
    \item \textbf{Project 5: redshift estimation of distant galaxies with deep learning} (NCSA SPIN internship) \hfill $\rceil$ %2023/10 - Present
    \begin{itemize}[leftmargin=1.5em]
