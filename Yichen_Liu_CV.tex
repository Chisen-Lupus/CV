...
\begin{itemize}[leftmargin=1.5em]
    ...
    \end{itemize}
    \item \yichen{\textbf{Project 3.1: black hole - host galaxy relation of AGNs in DES deep fields} \hfill $\rceil$} % 2023/06 - Present
    \begin{itemize}[leftmargin=1.5em]
    ...
    \end{itemize}
    \item \yichen{\textbf{Project 4: redshift estimation of galaxies using machine learning} (NCSA SPIN internship) \hfill $\rceil$} %2023/10 - Present
    \begin{itemize}[leftmargin=1.5em]
...
\begin{itemize}[leftmargin=1.5em]
    \item \textbf{Project: meteor slitless spectrum analysis captured by DSLR camera} \hfill $\rceil$
    \begin{itemize}[leftmargin=1.5em]
...
\begin{itemize}[leftmargin=1.5em]
    ...
    \end{itemize}
    \item \textbf{Project 2: image encryption based on computational ghost imaging} \hfill $\rceil$ %Sep 2021 - Feb 2022
    \begin{itemize}[leftmargin=1.5em]
    ...
    \end{itemize}
    \item \textbf{Project 3: Advancement in ghost imaging through neural network} \hfill $\rceil$ %Mar 2022 - May 2022
    \begin{itemize}[leftmargin=1.5em]
...
\begin{tabular}{@{}p{0.2\linewidth}@{}p{0.8\linewidth}@{}}
    \textbf{Summer schools}: & University of California Berkeley (4.000/4.000), 2022, Remote \hfill $\rceil$\\
...
\begin{section}{SUMMARY OF TECHNICAL SKILLS}
    ...
    \begin{tabular}{@{}p{0.2\linewidth}@{}p{0.8\linewidth}@{}}
        \textbf{Programming}: & Python/Jupyter, \LaTeX, MATLAB, Git, Arduino, Bash/Zsh, C/C++, Mathematica, Julia, docker, SQL, and Java  \hfill $\rceil$\\
