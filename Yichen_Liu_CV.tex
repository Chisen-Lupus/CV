...
\usepackage{amsmath}
\usepackage{enumitem}
\usepackage[left=0.5in,top=0.8in,right=0.5in,bottom=0.8in, letterpaper]{geometry}
\usepackage{hyperref}
...
\begin{itemize}[leftmargin=1.5em]
    ...
    \item Project 1 - deblending in astronomical surveys using machine learning %\hfill Sep 2022 - Present
    \begin{itemize}[leftmargin=1.5em]
