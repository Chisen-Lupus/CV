...
Summer sessions
\begin{itemize}[leftmargin=1.5em]
    \item \textbf{University of California, Berkeley} \hfill % 4.000/4.000 
    \textbf{Jun 2022 - Aug 2022} 
    \item \textbf{Shanghai Jiao Tong University} \hfill %4.00/4.00 
    \textbf{Jun 2021 - Jul 2021}
\end{itemize}
...
\begin{enumerate}[leftmargin=1.5em]
    \item Liu Y., et al., DES dwarf AGNs, In prep.
    \item Colin B., et al., Host galaxy properties of variable AGNs in the COSMOS field I. $M_{\rm{BH}}-M_{\ast}$ relation up to $z\sim4$, In prep.
    \item Grant Merz, \textbf{Yichen Liu}, Colin J. Burke, Patrick D. Aleo, Xin Liu, Matias Carrasco Kind, Volodymyr Kindratenko, Yufeng Liu, \href{https://arxiv.org/abs/2307.05826}{``Detection, Instance Segmentation, and Classification for Astronomical Surveys with Deep Learning (DeepDISC): Detectron2 Implementation and Demonstration with Hyper Suprime-Cam Data,"} submitted to MNRAS, available at ArXiv (2023)
    ...
    \item Peixia Zheng, \textbf{Yichen Liu}, and Hong-Chao Liu, \href{http://www.irla.cn/cn/article/doi/10.3788/IRLA20211058}{``Single-pixel imaging and metasurface imaging,"} Infrared and Laser Engineering 50.12, 20211058-1 (2022)
\end{enumerate}
...
\begin{itemize}[leftmargin=1.5em]
    ...
    \item Project 1 - deblending in astronomical surveys using machine learning (Summer 2023 \& Academic year 23-24 NCSA SPIN internship) %\hfill Sep 2022 - Present
    \begin{itemize}[leftmargin=1.5em]
