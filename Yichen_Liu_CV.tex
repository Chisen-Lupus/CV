...
(\input{ |python get_pubstat.py --ads_token Gh2X1K7QxOgpUq0kU3eG3QWNuer5wV6CaIjgkGdp --library_id sd_eU00XQcqL8jDJOntyRQ --name Ono})

    
\textbf{First-Author Publications}
\begin{enumerate}[leftmargin=1.5em]
    \input{ |python get_publist.py --ads_token Gh2X1K7QxOgpUq0kU3eG3QWNuer5wV6CaIjgkGdp --library_id sd_eU00XQcqL8jDJOntyRQ --name Ono --first_author True} 
\end{enumerate} 

\textbf{Co-Author Publications}

\begin{enumerate}[leftmargin=1.5em]
    \input{ |python get_publist.py --ads_token Gh2X1K7QxOgpUq0kU3eG3QWNuer5wV6CaIjgkGdp --library_id sd_eU00XQcqL8jDJOntyRQ --name Ono --first_author False} 
\end{enumerate}
